  ...
  return (
    <div className="help-content-inner">
      ...
      <section className="help-intro">
        ...
        <p>
          Les templates définissent la structure du message Discord (titre, corps, mise en forme). Ils contiennent des <strong>variables</strong> entre crochets (ex. <code>[Game_name]</code>, <code>[instruction]</code>, <code>[Overview]</code>) qui sont remplacées par les valeurs du formulaire <strong>au moment de leur écriture</strong> dans l'éditeur de contenu.
        </p>
      ...
      <section className="help-section help-section--info">
        ...
        <p>
          Toutes les variables disponibles sont listées sous la zone de contenu. Un clic sur une variable copie <code>[NomVariable]</code> dans le presse-papier pour l'insérer dans le template.
        </p>
      </section>
