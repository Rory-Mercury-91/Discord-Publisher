  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{
        ...
        <h3 style={{ margin: '0 0 8px', fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: 8 }}>
          🤖 Enrichissement automatique
          {status === 'running' && <span style={{ fontSize: 12, color: '#10b981' }}>● En cours</span>}
        </h3>
      ...
      <div style={{
        ...
        <strong style={{ display: 'block', marginBottom: 8, color: 'var(--text)' }}>ℹ️ Fonctionnement</strong>
